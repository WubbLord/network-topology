...
Nikhil focused on topology modeling, collective routing, and MoE workload
analysis. Brian focused on AccelForge integration, feedback-loop evaluation,
result aggregation, figure generation, and report assembly.
...
\texttt{report/technical\_summary.tex}. Experiment scripts, workload
definitions, result summaries, and report figures are organized under
\texttt{sweep\_matmuls.py}, \texttt{sweep\_moe.py}, \texttt{workloads/},
\texttt{figures/}, and \texttt{report/figs/}.
